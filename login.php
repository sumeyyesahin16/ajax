        ...
        <div class="col-sm-10 col-xl-2 col-md-6 mt-5" >
            <div class="card text-center" style="width: 20rem">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="giris.php"  class="login100-form validate-form"  id="#login_form">

                        <div class="form-floating mb-3 mt-6">
                            <input type="text" name="username" class="form-control" id="floatingInput" placeholder="name@example.com" style="border-color:#a80055 ;border-style: solid">
                            <label for="floatingInput">Kullanıcı Adı</label>
                        </div>
                        <div class="form-floating">
                            <input type="password" name="password" class="form-control" id="floatingPassword" placeholder="Password" style="border-color:#a80055 ">
                            <label for="floatingPassword">Şifre</label>
                        </div>
                        <input type="submit" class="btn btn-default text-white  mt-3" style="background-color:#a80055" value="Giriş">
                    </form>
